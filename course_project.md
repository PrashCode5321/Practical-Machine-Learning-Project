...
Checking what percentage of data is missing in these columns:
    ...
    ##                0.0000000                0.0000000                0.0000000 
    ##                 yaw_belt         total_accel_belt       kurtosis_roll_belt 
    ##                0.0000000                0.0000000                0.9795443 
    ##      kurtosis_picth_belt        kurtosis_yaw_belt       skewness_roll_belt 
    ##                0.9795443                0.9795443                0.9795443 
    ##     skewness_roll_belt.1        skewness_yaw_belt            max_roll_belt 
    ##                0.9795443                0.9795443                0.9795443 
    ##           max_picth_belt             max_yaw_belt            min_roll_belt 
    ##                0.9795443                0.9795443                0.9795443 
    ...
    ##                0.0000000                0.0000000                0.0000000 
    ##          total_accel_arm            var_accel_arm             avg_roll_arm 
    ##                0.0000000                0.9795443                0.9795443 
    ##          stddev_roll_arm             var_roll_arm            avg_pitch_arm 
    ##                0.9795443                0.9795443                0.9795443 
    ##         stddev_pitch_arm            var_pitch_arm              avg_yaw_arm 
    ##                0.9795443                0.9795443                0.9795443 
    ##           stddev_yaw_arm              var_yaw_arm              gyros_arm_x 
    ##                0.9795443                0.9795443                0.0000000 
    ##              gyros_arm_y              gyros_arm_z              accel_arm_x 
    ##                0.0000000                0.0000000                0.0000000 
    ##              accel_arm_y              accel_arm_z             magnet_arm_x 
    ##                0.0000000                0.0000000                0.0000000 
...
of predicting `X_val`:
    ...
    ## Sensitivity            1.0000   0.9991   0.0000   0.0000   1.0000
    ## Specificity            0.9998   1.0000   1.0000   1.0000   0.5857
    ## Pos Pred Value         0.9994   1.0000      NaN      NaN   0.3522
    ## Neg Pred Value         1.0000   0.9998   0.8257   0.8362   1.0000
    ## Prevalence             0.2845   0.1935   0.1743   0.1638   0.1839
    ## Detection Rate         0.2845   0.1934   0.0000   0.0000   0.1839
    ## Detection Prevalence   0.2846   0.1934   0.0000   0.0000   0.5220
    ## Balanced Accuracy      0.9999   0.9996   0.5000   0.5000   0.7928
...
Testing model’s performance on validation data:
    ...
    ## 
    ##                      Class: A Class: B Class: C Class: D Class: E
    ## Sensitivity            1.0000   0.9991   1.0000   1.0000   0.9982
    ## Specificity            0.9998   1.0000   1.0000   0.9996   1.0000
    ## Pos Pred Value         0.9994   1.0000   1.0000   0.9979   1.0000
    ## Neg Pred Value         1.0000   0.9998   1.0000   1.0000   0.9996
    ## Prevalence             0.2845   0.1935   0.1743   0.1638   0.1839
    ## Detection Rate         0.2845   0.1934   0.1743   0.1638   0.1835
    ## Detection Prevalence   0.2846   0.1934   0.1743   0.1641   0.1835
    ## Balanced Accuracy      0.9999   0.9996   1.0000   0.9998   0.9991
...
#### Submission set Prediction
    ...
    ##  A  A  B  A  A  A  A  A  A  A  B  B  A  A  A  A  A  A  A  A 
    ## Levels: A B C D E
